import { Lock, Radio, RadioIcon, Send, Users } from "lucide-react";
					...
					<div className="space-y-6 lg:col-span-5">
						<div className="rounded-xl border border-white/10 bg-gradient-to-br from-gray-950/50 to-black/50 p-6">
							<div className="mb-6 flex items-center gap-3">
								...
								<h3 className="text-lg text-white font-mono-ui">Transmission Details</h3>
							</div>
						...
						<div className="rounded-xl border border-white/10 bg-gradient-to-br from-gray-950/50 to-black/50 p-6">
							<div className="mb-6 flex items-center gap-3">
								...
								<h3 className="text-lg text-white font-mono-ui">Network Stats</h3>
							</div>
							...
							<div className="grid grid-cols-2 gap-4">
								{[
									...
									>
										<div className="mb-1 text-2xl text-white font-mono-ui">{stat.value}</div>
						...
						<div className="rounded-xl border border-white/10 bg-gradient-to-br from-gray-950/50 to-black/50 p-6">
							<h3 className="mb-4 text-sm text-gray-400">Recent Dispatch Topics:</h3>
							<div className="space-y-2 text-sm">
								{[
									...
									<div key={topic} className="flex items-start gap-2 text-gray-500 font-mono-ui">
