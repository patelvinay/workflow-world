		...
		<div className="space-y-6">
			<div className="relative">
				...
				<input
					...
					className="w-full rounded-lg border border-white/10 bg-black/40 py-3.5 pr-4 pl-12 text-sm text-white placeholder:text-gray-600 focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 focus:outline-none"
					style={monoStyle}
				/>
			</div>
				...
				{filterGroups.map((group, index) => {
					...
					return (
						<div
							...
							className={group.className ?? "lg:col-span-5"}
						>
				...
				<div className={sortConfig.className ?? "lg:col-span-2"}>
					...
					<div className="relative">
						...
						<select
							...
							className="w-full cursor-pointer appearance-none rounded-lg border border-white/10 bg-black/40 py-2 pr-3 pl-10 text-xs text-white transition-all focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 focus:outline-none"
							style={monoStyle}
						>
