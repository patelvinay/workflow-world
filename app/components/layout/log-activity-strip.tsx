	...
	return (
		<div>
			...
			<div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
				{metrics.map((metric) => (
					...
					>
						...
						<div className="mb-1 text-xs uppercase tracking-wider text-gray-600" style={monoStyle}>
							{metric.label}
						</div>
			...
			<div className="mt-8 rounded-xl border border-white/10 bg-gradient-to-r from-gray-950/30 to-black/30 p-6">
				<div className="mb-6">
					<div className="mb-2 text-xs uppercase tracking-wider text-gray-600" style={monoStyle}>
				...
				<div className="grid grid-cols-6 gap-3">
					{timeline.map((item) => (
						<div key={item.month} className="flex flex-col items-center">
							...
							<div className="mt-2 text-xs text-gray-600" style={monoStyle}>
								{item.month}
							</div>
